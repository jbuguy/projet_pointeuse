...
export default function SuiviHeure() {
    ...
    return (
        <div className="suiviHeure">
            <div className="tabs">
                <div className="tab tab-active">logs</div>
                <div className="tab">Suivi d'Heures</div>
            </div>
